(function() {
  ...
  function setup_rollbar() {
    var _rollbarConfig = {
      accessToken: "c67f494318b747099e8e9125ae992ceb",
      captureUncaught: true,
      captureUnhandledRejections: true,
      payload: {
        person: {
          id: localStorage.getItem("cf-uuid"), // required
          username: localStorage.getItem("cf-user-full-name"),
          email: localStorage.getItem("cf-email-sent"),
        },
        environment: env.CF_ENVIRONMENT_TYPE,
        client: {
          javascript: {
            source_map_enabled: true,
            code_version: env.GIT_CURRENT_REVISION,
