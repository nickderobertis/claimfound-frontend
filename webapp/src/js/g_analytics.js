...
(function() {
  ...
  var bd = function(a) {
      ...
      return protocol + env.BE_DOMAIN + "/g-proxy";
    },
    Da = function(a) {
      this.name = "len";
      this.message = a + "-8192";
  ...
  var p = /^(GTM|OPT)-[A-Z0-9]+$/,
    ...
    t = function(a) {
      ...
      var c = env.BE_DOMAIN + "/g-proxy/gtm/js?id=" + K(a.id);
  ...
  var u = function(a, b, c) {
    ...
    B = function(a) {
      ...
      if (D(a.url, env.BE_DOMAIN + "/g-proxy/gtm/js?id=")) return !0;
      if (a.query || 0 <= a.url.indexOf("?") || 0 <= a.path.indexOf("://"))
        return !1;
      if (a.host == b.host && a.port == b.port) return !0;
      b = "http:" == a.protocol ? 80 : 443;
      return env.BE_DOMAIN + "/g-proxy" == a.host &&
        (a.port || b) == b &&
        D(a.path, "/plugins/")
        ? !0
        : !1;
