...
DeserializationMethods[BSON.BSON_DATA_OID] = function(
  name,
  object,
  buffer,
  index
...
DeserializationMethods[BSON.BSON_DATA_INT] = function(
  name,
  object,
  buffer,
  index
...
DeserializationMethods[BSON.BSON_DATA_TIMESTAMP] = function(
  name,
  object,
  buffer,
  index
...
DeserializationMethods[BSON.BSON_DATA_STRING] = function(
  name,
  object,
  buffer,
  index
...
DeserializationMethods[BSON.BSON_DATA_BOOLEAN] = function(
  name,
  object,
  buffer,
  index
...
var deserializeObject = function(buffer, options, isArray) {
  ...
  var fieldsAsRaw =
    options["fieldsAsRaw"] == null ? {} : options["fieldsAsRaw"];
